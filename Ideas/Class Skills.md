...
When using any melee weapon which adds damage based on the Strength modifier, you may choose to ignore the value of the weapon's base damage roll, which is generally Piercing, Bludgeoning, or Slashing damage.  If you do, instead roll Xd4 + your Proficiency Bonus of the same damage type as the weapon, where X is equal to your Strength modifier, plus one if wielded with two hands.  If this is done with an improvised or weakened weapon, that weapon breaks and becomes unusable after dealing damage.
